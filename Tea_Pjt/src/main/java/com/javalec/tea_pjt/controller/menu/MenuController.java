...
public class MenuController {
	...
	public String attendance(HttpServletRequest request, HttpSession session, Model model) {
		String atYear = request.getParameter("atYear");
		String atMonth = request.getParameter("atMonth");
		String atDate = request.getParameter("atDate");
		MemberDTO mDto = (MemberDTO) session.getAttribute("user");
		String user_id = mDto.getUser_id();
		int reAt = aService.attendance(user_id);
		
		AttendanceDTO attendanceChk = aService.monthAttendance(user_id, atYear, atMonth);
